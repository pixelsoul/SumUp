                ...
                articles
                    .map((article, index) => (
                        <div
                            ...
                            className={`p-3 flex flex-row bg-neutral-50 dark:bg-neutral-900 border gap-3 rounded-md cursor-pointer transition-colors animate-in animate-out slide-out-to-top-0 ${
